...
% approximation using Lagrange Base Polynomial
pLagrange = polyfit(x,y2,length(x) + 1); % Order of Lagrange Base Polynomial -> #Nodes +1
fLagrange = polyval(pLagrange,x);
...
plot(x,fLagrange,'color','k','linewidth',3)
grid on
legend('Desired','Approximated','Lagrange Polynomial')
